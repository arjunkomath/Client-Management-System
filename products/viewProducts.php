...
<html lang="en">
  ...
  <h1>List of Products <small>Click Product name for details </small> <a href="export.php"><button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-cloud-download"></span> Export</button></a></h1>
	</div>
 ...
 { 
   ...
   echo '<td style="width:5%;">'.$info['id'].'</td>';
      echo '<td style="width:40%;"><a href="report.php?id='.$info['id'].'">'.$info['name'].'</a></td>';
 ...
 echo " <a href='{$_SERVER['PHP_SELF']}?pagenum=$last'>".'<span class="label label-primary glyphicon glyphicon-step-forward">Last</span></a> ';
	 ...
	 echo '<div class="alert alert-danger">No Products to display! Click <a href="add.php">here</a> to Add.</div>';
 }
 ?> 
