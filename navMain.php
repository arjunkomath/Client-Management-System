...
<nav class="navbar navbar-default navbar-static-top" role="navigation">
      <div class="container">
        ...
        <li class="active"><a href="home.php">View Clients</a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="products/removeProducts.php">Remove</a></li>
            <li class="divider"></li>
            <li><a href="products/search.php">Search</a></li>
          </ul>
        </li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Settings <b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li><a href="clients/emailSettings.php">e-mail settings</a></li>
          </ul>
        </li>
      </ul> 
